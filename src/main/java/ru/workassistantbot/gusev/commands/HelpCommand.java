...
public class HelpCommand {
    public SendMessage answer(Update update){
        ...
        message.setText("Для того чтобы добавить выполненную тобой работу, используй команду /add_work. Далее " +
                ...
                " и через запятую расценку за единицу выполненой работы." +
                "\n(Например: \"Почесал_голову, 0.3\")\n\n Если хочешь посмотреть таблицу с данными о твоей работе," +
                " воспользуйся коммандой /get_excel.\n\n Если хочешь чтобы я посчитал примерную стоимость твоих работ на сегодня, " +
                "используй /how_much.");
        return message;
    }
}
